import RequestProject.CycleCollapse
import RequestProject.External

/-!
# Negative direction plumbing (§5, §7)

This file connects the §4 bridge-trace necessity results (`RequestProject.CycleCollapse`)
...
theorem liftHG_tripleSystem {α : Type u} (A : SimpleGraph α) (κ : Cardinal.{u}) :
  ...
  intro e he;
  convert Set.ncard_eq_three.mpr ( Erdos593.liftHG_isTripleSystem A κ e he )
...
bridge-trace machinery is discharged here (`RequestProject.CycleCollapse`); the
